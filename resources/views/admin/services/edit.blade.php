...
<div class="max-w-3xl">
    <div class="bg-white rounded-lg shadow-md p-6">
        <form method="POST" action="{{ route('admin.services.update', $service->_id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <input type="text" name="prefix" id="prefix" value="{{ old('prefix', $service->prefix) }}" 
                ...
                <p class="text-xs text-gray-500 mt-1">Máximo 5 caracteres. Se usará para generar códigos de turno</p>
                @error('prefix')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
