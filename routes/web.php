...
Route::post('/login', [LoginController::class, 'sendPin'])->name('login.sendPin'); 
...
Route::middleware(['auth', 'role:cashier'])->prefix('cashier')->name('cashier.')->group(function () {
    ...
    Route::post('/call-next', [CashierDashboardController::class, 'callNext'])->name('call-next');
    Route::post('/finish-current', [CashierDashboardController::class, 'finishCurrent'])->name('finish-current');
});